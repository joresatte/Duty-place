...
class RequestRepository:
    ...
    def init_tables(self):
        sql = U.createTable(self, tables_variables= ['id', 'name', 'email', 'subject', 'comments'], tableName= "requestables")
    ...
    def save(self, request):
        sql= U.getFullSaveDynamicQuery(self, table_variables= ['id', 'name', 'email', 'subject', 'comments'], tableName= "requestables")
        conn= self.create_conn()
        cursor = conn.cursor()
        cursor.execute(
            sql,
